		...
		if (!_.isUndefined(window.ymaps)) {
			...
			function init() {
				...
				myPlacemark = new ymaps.Placemark([55.718324068999664, 37.79198949999998], {
					...
					iconImageHref: '/local/templates/main/assets/images/icon-balloon-red.png',
					iconImageSize: [36, 51],
...
App.Control.install({
	...
	renderMode: function () {
		var self = this;
		if ($(window).outerWidth() <= 767 || this.sliderLenght > 3) {
			self.initSlider();
		} else {
			self.destroySlider();
		}
...
var MainSliderRd = {
	...
	initialize: function () {
		...
		this.removedElement = this.$('.js-main-slider-rd__deleted-after-download')
		//this.removedSlides.hide();
...
var FileIconInput = {
	...
	getTooltipLg: function (fileName) {
		var self = this;
		this.fileInputDetach = this.fileInput.detach();
