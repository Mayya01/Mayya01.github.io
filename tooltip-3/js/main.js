...
var FileIconInput = {
	...
	getTooltipLg: function (fileName) {
		...
		this.downoladField.html('Загружено 1').addClass('no-clip');

		this.downoladFieldLabel.hover(function () {
			self.downoladField.addClass('bordered');
			self.toolTip
				.removeClass('hidden')
			...
			self.downoladField.removeClass('bordered');
			self.toolTip
				.addClass('hidden')
		});
	},
	...
	removeFile4List: function (evt, tooltip) {
		...
		this.downoladField.removeClass(' bordered no-clip').html(this.downoladFieldText);
