...
$arTemplateParameters["SHOW_REQUIRED"] = array(
	"NAME" => "Показывать обязательные поля",
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "Y"
);

$arTemplateParameters["SHOW_COLON"] = array(
	"NAME" => "Показывать двоеточие после названия поля",
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N"
);
