...
$arTemplateParameters['HIDE_PREORDER_BLOCK'] = array(
    'PARENT' => 'VISUAL',
    'NAME' => "Скрывать блок заказать",
    'TYPE' => 'LIST',
    'VALUES' => array(
        'NONE' => 'Не скрывать',
        'BUY' => 'Скрывать продажу',
        'RENT' => 'Скрывать аренду',
    ),
    'DEFAULT' => 'NONE',
    'ADDITIONAL_VALUES' => 'Y'
);
...
$arTemplateParameters['DISCOUNT_DATE'] = array(
    'PARENT' => 'EXTENDED_SETTINGS',
    'NAME' => 'Скидка до',
    'TYPE' => 'STRING',
    'MULTIPLE' => 'N',
