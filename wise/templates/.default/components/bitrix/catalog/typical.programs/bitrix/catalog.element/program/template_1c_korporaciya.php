        ...
        <div class="c-programm-features">
            ...
            <div class="c-offers">
                <div class="c-offers__inner">
                    <div class="c-offers__wrapper">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/1c_korporation/holding.png" alt="">
                        <span class="c-offers__descr">1С:Управление холдингом 8»</span>
                        <span class="c-offers__price">1 250 000 руб</span>
                    </div>
                    <div class="c-offers__wrapper _width">
                        <div class="c-offers__img">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/1c_korporation/company1c.png" alt="">
                        </div>
                        <div class="c-offers__img">
                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/1c_korporation/salary.png" alt="">
                        </div>
                        <div class="c-offers__common">
                            <span class="c-offers__descr">«1С:ERP Управление предприятием 2» включает «1С:Зарплата и управление персоналом 8 КОРП»</span>
                            <span class="c-offers__price">360 000 руб</span>
                        </div>
                    </div>
                    <div class="c-offers__wrapper">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/1c_korporation/documents.png" alt="">
                        <span class="c-offers__descr">«1С:Документооборот 8 КОРП»</span>
                        <span class="c-offers__price">187 000 руб</span>
                    </div>
                </div>
                <div class="c-offers__inner">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/img/1c_korporation/product-box-middle.png" alt="">
                    <div class="c-offers__best">
                        <div class="c-offers__choice-name">«1С:Корпорация»</div>
                        <s class="c-offers__red-line-through">
                <span class="c-offers__through-text"> от 1 797 000
                    <span itemprop="priceCurrency"> руб</span>
                </span>
                        </s> &nbsp;&nbsp;
                        <div class="c-offers__real-price">
                            <span>1 610 000 руб</span>
                        </div>
                        <div class="c-offers__profit">
                            <span>Ваша выгода 187 000 руб</span>
                        </div>
                    </div>
...
<?if ($arResult["ID"] == "39" ) {?>
	<!--noindex-->
	<section class="c-partner-info">
		<? LazyLoad::includeFile(SITE_DIR.'/local/include/blocks/tenders/tender.php') ?>
	</section>
	<!--/noindex-->
<?}?>
