...
switch ($arResult['VARIABLES']['SECTION_CODE']) {
	case 'zup-8':
		$arResult['VARIABLES']['ELEMENT_CODE'] = 'zup-' . $arResult['VARIABLES']['ELEMENT_CODE'];
		$arResult['CUT_ELEMENT_CODE_PART'] = 'zup-';
		break;
	case '1s-crm':
		if($arResult['VARIABLES']['ELEMENT_CODE'] === 'standart') {
			$arResult['VARIABLES']['ELEMENT_CODE'] = 'srm-' . $arResult['VARIABLES']['ELEMENT_CODE'];
		} else {
			$arResult['VARIABLES']['ELEMENT_CODE'] = 'crm-' . $arResult['VARIABLES']['ELEMENT_CODE'];
		}
		$arResult['CUT_ELEMENT_CODE_PART'] = ['crm-', 'srm-'];
		break;
	case '1s-roznica-8':
		$arResult['VARIABLES']['ELEMENT_CODE'] = 'roznica-' . $arResult['VARIABLES']['ELEMENT_CODE'];
		$arResult['CUT_ELEMENT_CODE_PART'] = 'roznica-';
		break;
	case 'dokumentooborot-8':
		if($arResult['VARIABLES']['ELEMENT_CODE'] == 'korp') {
			$arResult['VARIABLES']['ELEMENT_CODE'] = 'doc-' . $arResult['VARIABLES']['ELEMENT_CODE'];
			$arResult['CUT_ELEMENT_CODE_PART'] = 'doc-';
		} else {
			$arResult['VARIABLES']['ELEMENT_CODE'] = 'docs-' . $arResult['VARIABLES']['ELEMENT_CODE'];
			$arResult['CUT_ELEMENT_CODE_PART'] = 'docs-';
		}
		break;
	case 'upravlenie-nebolshoi-firmoi-8':
		$arResult['VARIABLES']['ELEMENT_CODE'] = 'unf-' . $arResult['VARIABLES']['ELEMENT_CODE'];
		$arResult['CUT_ELEMENT_CODE_PART'] = 'unf-';
		break;
	case 'upravlenie-torgovlei-8':
		$arResult['VARIABLES']['ELEMENT_CODE'] = 'ut-' . $arResult['VARIABLES']['ELEMENT_CODE'];
