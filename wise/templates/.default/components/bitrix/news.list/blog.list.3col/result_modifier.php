...
$arResult['ITEMS'] = $arBlogElements->formatTags()->formatDate()->resizePhoto($arParams['SECTION'])->getElements();
$arResult['LAST_YEAR'] = BlogHelper::getYear($arResult['ITEMS'][count($arResult['ITEMS'])-1]['displayYear']);
...
if($_REQUEST['AJAX']=='Y' AND $_REQUEST['LAST_ELEM_YEAR']){
	$arResult['LAST_YEAR_PREV_PAGE'] = $_REQUEST['LAST_ELEM_YEAR'];
}
$arResult['CURRENT_MONTH'] = BlogHelper::getMonth($arResult['ITEMS'][0]['monthNum']);
