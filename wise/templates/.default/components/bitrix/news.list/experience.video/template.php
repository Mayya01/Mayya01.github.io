...
?>
	<div class="experience-section__caption h2">
		<a class="default-link" title="Видео-отзывы" href="/o-kompanii/nash-opyt/#videoReviewsBlock" rel="Видео-отзывы">Видео-отзывы</a>
	</div>
	...
	<? else: ?>
		<div class="c-about__video-reviews clear js-video-reviews-list section-padding-bottom" id="videoReviewsBlock">
