								...
								<div class="contact-modal__field<?= ($arQuestion['CODE'] == 'FORM_EMAIL') ? ' hide-up-to-md' : '' ?>">
									<div
										...
										<? if($arQuestion["CODE"] == "FORM_PHONE"):?>
											<span class="b-qtool _modal" title="Мы свяжемся с вами в течение 15 минут <?=PHP_EOL?>для уточнения параметров расчета">?</span>
										<? endif; ?>
										<? if($arQuestion["CODE"] == "FORM_EMAIL"): ?>
											<span class="b-qtool _modal" title="Мы отправим коммерческое предложение <?=PHP_EOL?>на указанный электронный адрес">?</span>
										<? endif; ?>
									</div>
