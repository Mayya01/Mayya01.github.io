...
<div class="<?= $arParams['FORM_CONTAINER_CLASS'] ?> " id="<?= $arParams['FORM_CONTAINER_ID'] ?>">
    ...
    <? if ($arResult["isFormNote"] != "Y") : ?>
        ...
        <input type="hidden" data-fieldtype="formName" value="BuyProgram"/>
        ...
        <? foreach ($arResult["VISIBLE_QUESTIONS"] as $kkey => $arQuestion): ?>
            ...
            <? else: ?>
                <div class="contact-modal__field">
                    <div
                        class="contact-modal__label <? if ($arQuestion["REQUIRED"] == "Y"): ?>_necessary<? endif ?>"><?= $arQuestion["CAPTION"] ?>
                    ...
                    <div class="contact-modal__item">
                        <? if ($arQuestion["CODE"] == "FORM_TARIFF"): ?>
                            <select class="select2 js-obs-tariff-select"
                                    ...
                                    data-fieldtype="tocomment" data-fieldlabel="<?= $arQuestion["CAPTION"] ?>"
                            >
		...
		<? showAcceptCheckbox('buy-program', 'Отправить заявку', 'Мы&nbsp;перезвоним в&nbsp;течение 15 минут в&nbsp;рабочее время'); ?>
