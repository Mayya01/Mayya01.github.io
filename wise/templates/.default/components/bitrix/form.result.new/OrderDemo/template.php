...
<div class="<?= $arParams['FORM_CONTAINER_CLASS'] ?> js-typical-form " id="<?= $arParams['FORM_CONTAINER_ID'] ?>">
    ...
    <input type="hidden" data-fieldtype="formName" value="OrderDemo"/>
    ...
    <? elseif ($arQuestion["CODE"] == "FORM_NO_DETAILS"): ?>
        ...
        <div class="contact-modal__field">
            <div class="contact-modal__item">
                <div class="contact-modal__inputs _left _white-checkbox _checkbox-wrapper">
                    <?= $arQuestion["HTML_CODE"] ?>
                    <div class="contact-modal__error">Неверно заполнено имя</div>
                    <div class="contact-modal__none">Заполнение имени обязательно</div>
                </div>
            </div>
        </div>
    ...
    <div class="contact-modal__calc-section _top-line">
        <div class="contact-modal__calc-data">
            ...
            <? elseif ($arQuestion["CODE"] == "FORM_TARGET"): ?>

                <div class="contact-modal__field  _lined">
                    <div class="contact-modal__label">Выберите формат демонстрации</div>
                    <div class="contact-modal__item">
                        <div class="contact-modal__inputs">
                            <ul class="contact-modal__inputs-list">
                                <li>
                                    <label class="contact-modal__radio">
                                        <input type="radio" data-name="format" data-fieldtype="tocomment"
                                               data-fieldlabel="Выберите формат демонстрации"
                                               data-fieldname="form_<?= $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] ?>_<?= $arQuestion["STRUCTURE"][0]["ID"] ?>"
                                               name="form_<?= $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] ?>_<?= $arQuestion["STRUCTURE"][0]["ID"] ?>"
                                               value="В вашем офисе" checked="checked" class="icheck"/>
                                        <span>В вашем офисе</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="contact-modal__radio">
                                        <input type="radio" data-name="format" data-fieldtype="tocomment"
                                               ...
                                               data-fieldname="form_<?= $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] ?>_<?= $arQuestion["STRUCTURE"][0]["ID"] ?>"
                                               name="form_<?= $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] ?>_<?= $arQuestion["STRUCTURE"][0]["ID"] ?>"
                                               value="Дистанционно" class="icheck"/>
            ...
            <? elseif ($arQuestion["CODE"] == "FORM_ANALIZ"): ?>
                ...
                <div class="contact-modal__field">
                    <div class="contact-modal__item">
                        ...
                        <div class="contact-modal__inputs _left _small-textarea js-typicalform-checkbox-wrapper">
                            <b class="contact-modal__inputs-title"><?= $arQuestion["CAPTION"] ?></b>
			...
			<? showAcceptCheckbox('order-demo', 'Заказать демонстрацию'); ?>
