...
<div class="<?= $arParams['FORM_CONTAINER_CLASS'] ?> js-typical-form " id="<?= $arParams['FORM_CONTAINER_ID'] ?>">
		...
		<? if ($arResult["isFormNote"] != "Y") : ?>
				...
				<input type="hidden" data-fieldtype="formName" value="ArendaProgram"/>
			...
			<? showAcceptCheckbox('arenda-programm', 'Отправить заявку'); ?>
				...
				<!--<div class="form-standart__field">
					<div class="form-standart__item">
						<div class="form-standart__inputs _left _white-checkbox _checkbox-wrapper">
								...
								<input type="checkbox" class="icheck inputtext" id="arenda-programm-privicy" checked data-necessary="data-necessary" required>
							...
							<div class="form-standart__none">Для продолжения нужно согласие с условиями</div>
						</div>
					</div>
				</div>-->
				</div>
