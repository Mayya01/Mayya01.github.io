...
$pr_list_1c_fresh = FormHelper::getProgramsListForFormSelect(array(1,2,10,5,9));
unset($pr_list_1c_fresh[0]);
$arResult["PROPGRAMM_SECTIONS"] = array_merge( array("Выберите из списка...", "1С:Предприниматель 2015"), $pr_list_1c_fresh);
